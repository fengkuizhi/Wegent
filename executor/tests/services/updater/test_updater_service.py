...
class TestUpdaterService:
    ...
    def test_init_with_auto_confirm(self):
        """Test UpdaterService initialization with auto_confirm."""
        service = UpdaterService(auto_confirm=True)
        assert service.auto_confirm is True

    @pytest.mark.asyncio
    async def test_check_and_update_already_latest(self):
    ...
    @pytest.mark.asyncio
    async def test_check_and_update_update_available_user_confirms(self):
    ...
    @pytest.mark.asyncio
    async def test_check_and_update_auto_confirm(self):
    ...
    @pytest.mark.asyncio
    async def test_check_and_update_user_declines(self):
    ...
    @pytest.mark.asyncio
    async def test_check_and_update_insufficient_disk_space(self):
    ...
    @pytest.mark.asyncio
    async def test_check_and_update_download_fails(self):
    ...
    @pytest.mark.asyncio
    async def test_check_and_update_replace_fails(self):
    ...
    def test_confirm_update_yes(self):
    ...
    def test_confirm_update_yes_uppercase(self):
    ...
    def test_confirm_update_default(self):
    ...
    def test_confirm_update_no(self):
    ...
    def test_confirm_update_keyboard_interrupt(self):
    ...
    def test_get_current_binary_path_frozen(self):
    ...
    def test_get_current_binary_path_not_frozen(self):
