...
class UpdaterService:
    ...
    def __init__(self, update_config: UpdateConfig, auto_confirm: bool = False):
    ...
    async def check_and_update(self) -> UpdateResult:
        ...
        if self.update_config.is_registry():
            ...
            logger.info("Update source: GitHub (wecode-ai/Wegent)")
            print("  Source: GitHub (wecode-ai/Wegent)")
